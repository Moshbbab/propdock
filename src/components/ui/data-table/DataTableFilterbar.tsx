...
import { conditions, regions, statuses } from "@/components/data/data"
      ...
      <div className="flex w-full flex-col gap-2 sm:w-fit sm:flex-row sm:items-center">
        ...
        {isFiltered && (
          <Button
            ...
            className="border border-warm-grey-2/20 px-2 font-semibold text-indigo-600 sm:border-none sm:py-1 dark:border-warm-grey-1/20 dark:text-indigo-500"
          >
            Clear filters
          </Button>
        )}
