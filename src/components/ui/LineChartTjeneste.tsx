...
const numberFormatter = (number: number) =>
  `${Intl.NumberFormat("no", { maximumFractionDigits: 0 }).format(number)} kr/m²`

export default function LineChartTjeneste() {
  return (
    <div className="flex min-h-[400px] w-full items-center justify-center">
      <div className="w-full max-w-3xl">
        <div
          className={cx(
            "relative select-none rounded-xl border transition-all duration-700",
            "border-warm-grey/10 dark:border-warm-white/10",
            "bg-warm-grey/5 dark:bg-warm-grey/20",
            "backdrop-blur-sm",
            "after:absolute after:bottom-0 after:left-0 after:h-[30%] after:w-full after:bg-gradient-to-t after:from-warm-white/20 after:to-transparent after:content-[''] dark:after:from-warm-grey/20",
          ...
          <div className="p-6">
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2">
                <span className="relative inline-block rounded-full bg-warm-grey/5 p-1 ring-1 ring-warm-grey/5 dark:bg-warm-grey/20 dark:ring-warm-white/5">
                  <RiArrowRightUpLine className="size-4 text-light-blue" />
                </span>
                <h3 className="bg-gradient-to-t from-warm-grey to-warm-grey-3 bg-clip-text text-lg font-semibold tracking-tight text-transparent dark:from-warm-white dark:to-warm-grey-1">
                  Pris per kvadratmeter
                </h3>
              </div>
              <p className="text-sm text-warm-grey-2 dark:text-warm-grey-1">
                Prisutvikling per kvadratmeter for ulike segmenter i Nord-Norge
              </p>
            </div>
            <div className="mt-8 h-[300px]">
              <LineChart
                data={data}
                index="date"
                categories={["Kontor", "Handel", "Logistikk"]}
