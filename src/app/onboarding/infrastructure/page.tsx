    ...
    <main className="mx-auto p-4">
      ...
      <form onSubmit={handleSubmit} className="mt-8">
        <div className="flex flex-col gap-6">
          <fieldset
            className="motion-safe:animate-revealBottom space-y-2"
            style={{
          ...
          <div
            className="motion-safe:animate-revealBottom flex flex-col items-start gap-8 sm:flex-row"
            style={{
              animationDuration: "500ms",
          ...
          <Card
            className="motion-safe:animate-revealBottom mt-4 space-y-1 border-gray-300 dark:border-gray-800"
            style={{
              animationDuration: "500ms",
